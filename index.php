...
<html lang="en">
  ...
  <head>
    ...
    <title>Friendly Bike - Pelotas</title>
  ...
  <?php
    ...
    */
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">FRIENDLY BIKE</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Parceiros</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">PARCEIROS</h2>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                ...
                <img class="img-fluid" src="img/gear-tools.svg" alt="">
                </a>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 ml-auto">
            <p class="lead">Você ciclista, morador(a) de Pelotas, você sabe quais estabelicimentos locais são nossos amigos? Se sua resposta for não saiba que seus problemas acabaram.</p>
          </div>
          <div class="col-lg-4 mr-auto">
            <p class="lead">A FRIENDLY BIKE é uma plataforma colaborativa onde você irá descobrir quais estabelicimentos locais são adeptados da bicicleta. A plataforma é alimentada por ciclista para ciclista.</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 mb-5 mb-lg-0">
            ...
            <p class="lead mb-0">Rua indefinida
              <br>Pelotas/RS</p>
          </div>
          <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <div class="col-md-4">
            ...
            <p class="lead mb-0">FRIENDLY BIKE é uma plataforma sem fins lucrativos de ciclistas para ciclistas criada por
              <a href="http://startbootstrap.com">apaixonado por bicicletas</a>.</p>
          </div>
        </div>
      </div>
    </footer>
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; friendly bike <?php echo date('Y') ?></small>
      </div>
    </div>
    ...
    function myMap() {
    var mapProp= {
        center:new google.maps.LatLng(-31.771639,-52.3407120),
        zoom:15,
    };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCe-iDNWrpIFU6D5ZUwdoakMYmDdTNs8co
